...
namespace KidGame.Lessons.Memory03
{
    ...
    public class Egg : MonoBehaviour, IPointerDownHandler
    {
        ...
        public event Action<ECandies> EggChoosed;
        ...
        private const int TopShift = 140;

        private ISoundManager SoundManager;
        private ITimers Timers;

        private ECandies CurrentCandy; //toDo: better make it via enum, but.. to think about
        ...
        public void SetObject(ECandies fruit)
        {
            CurrentCandy = fruit;
            ...
            Objects[(int)CurrentCandy].SetActive(true);
        }

        public ECandies GetObject()
        {
            return CurrentCandy;
        }
