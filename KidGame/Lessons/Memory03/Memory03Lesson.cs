...
namespace KidGame.Lessons.Memory03
{
    ...
    public class Memory03Lesson : ILesson
    {
        public event Action Ended;
        public event Action EndedWithReward;

        private IMemory03View View;

        private IGame Game;
        private IResourceManager Resources;

        private ECandies Question;
        ...
        public Memory03Lesson(Transform parent, ELessons lesson)
        {
            ...
            View = factory.CreateMemory03View();
        ...
        private List<ECandies> GetHand()
        {
            var hand = new List<ECandies>();

            var heap = Enum.GetValues(typeof(ECandies)).Cast<ECandies>().ToList();
        ...
        private void HandleChoiceMade(ECandies fruit)
        {
