...
{
    public class Memory02View : MonoBehaviour, IMemory02View
    {
        public event Action BackButtonPressed;
        public event Action<EGems> ChoosedFruit;
        ...
        private void HandleCardClick(EGems target)
        {
        ...
        public IPromise SetupAndShowContainers(List<EGems> hand)
        {
        ...
        public IPromise ShowQuestion(EGems quest)
        {
        ...
        public IPromise ShowTutorial(EGems right)
        {
            BackButton.gameObject.SetActive(false);

            var handTarget = GetProperContainer(right);

            return Tutorial.Show(null, handTarget, handTarget, new Vector3(0f, 0f, 0), new Vector3(0f, -120f, 0), true)
                .Done(() => BackButton.gameObject.SetActive(true));
        }

        private Transform GetProperContainer(EGems rightAnswer)
        {
