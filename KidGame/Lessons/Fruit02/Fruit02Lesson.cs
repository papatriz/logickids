...
namespace KidGame.Lessons.Fruit02
{
    ...
    public class Fruit02Lesson : ILesson
    {
        public event Action Ended;
        public event Action EndedWithReward;

        private IFruit02View View;
        ...
        public Fruit02Lesson(Transform parent, ELessons lesson)
        {
            ...
            View = factory.CreateFruit02View();
        ...
        private EFruitType GetFakeColor(EFruitType rightColor)
        {
        ...
        {
            var typesCount = Enum.GetValues(typeof(EFruitType)).Length;

            var proper = (EFruitType)Random.Range(0, typesCount);
            var fake = GetFakeColor(proper);

            View.SetupAndShowBowl(proper);

            View.ShowAllFruits(proper, fake)
