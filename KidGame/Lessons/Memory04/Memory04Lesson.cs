...
namespace KidGame.Lessons.Memory04
{
    ...
    public class Memory04Lesson : ILesson
    {
        public event Action Ended;
        public event Action EndedWithReward;

        private IMemory04View View;

        private IGame Game;
        private IResourceManager Resources;

        private EJellies Question;
        ...
        public Memory04Lesson(Transform parent, ELessons lesson)
        {
            ...
            View = factory.CreateMemory04View();
        ...
        private List<EJellies> GetHand()
        {
            var hand = new List<EJellies>();

            var heap = Enum.GetValues(typeof(EJellies)).Cast<EJellies>().ToList();
        ...
        private void HandleChoiceMade(EJellies fruit)
        {
