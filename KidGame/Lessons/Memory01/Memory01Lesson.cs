...
namespace KidGame.Lessons.Memory01
{
    ...
    public class Memory01Lesson : ILesson
    {
        public event Action Ended;
        public event Action EndedWithReward;

        private IMemory01View View;

        private IGame Game;
        private IResourceManager Resources;

        private EFruits Question;
        ...
        public Memory01Lesson(Transform parent, ELessons lesson)
        {
            ...
            View = factory.CreateMemory01View();
        ...
        private List<EFruits> GetHand()
        {
            var hand = new List<EFruits>();

            var heap = Enum.GetValues(typeof(EFruits)).Cast<EFruits>().ToList();
        ...
        private void HandleChoiceMade(EFruits fruit)
        {
