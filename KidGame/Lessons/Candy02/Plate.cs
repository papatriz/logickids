...
namespace KidGame.Lessons.Candy02
{
    ...
    {
        public event Action<ECandySize> Filled = (t) => { };
        ...
        public IPromise PutObjectInPlace(Candy candy)
        {
            ...
            var slot = (CurrentSlot == 0) ? Slot01Position[(int)form] : (CurrentSlot == 1)? Slot02Position[(int)form] : Slot03Position[(int)form];
